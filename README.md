...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/DNmrfFde2a)
...
```sh
npx nx serve react-newrelic-demo
```

To create a production bundle:

```sh
npx nx build react-newrelic-demo
```

To see all available targets to run for a project, run:

```sh
npx nx show project react-newrelic-demo
```
